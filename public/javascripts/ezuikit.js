...
(function (global, factory) {
    ...
    var appKey = "291da54b31034d1685d7661726fa2de5";
...
// 加载js
    ...
    EZUIPlayer.prototype.initDecoder = function (playParams) {
        ...
        function initDecoder(resolve, reject) {
            var jsPluginPath = '/assets/javascripts/js/jsPlugin-1.2.0.min.js?v=20211012';
         ...
         */
        var errorCodeLan = 'zh';
        var errorCodePath = "/assets/javascripts/js/errorCode.json";
        var errorCodeKey = 'errorCode';
        if(_this.opt.domain !== 'open'){
            errorCodeLan = 'en';
            errorCodePath = "/assets/javascripts/js/errorCode-EN.json";
...
EZUIPlayer.prototype.capturePicture = function (iWind, pictureName,callback,isUndownload) {
    if (!!this.jSPlugin) {
        console.log("hahahahahah"+pictureName + " 1 " + iWind + " 2 " + callback  +" 3 " + isUndownload)
