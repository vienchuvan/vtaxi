...
import entity.ObjectGiaoDichBaoCaoChung;
...
public class Utility {
    ...
    public static List<TaiKhoanThuongDungObject> TKThuongDungList;
    public static int SoLuongBaiViet = 15;

    public static List<ObjectGiaoDichBaoCaoChung> listGiaoDichBaoCaoChung;
...
//                        user.equals("0395981506")||   //duyen
    ...
    public static Boolean VIP(String id)
    {
        ...
        listVIP.add("0981455707");    // Tú

        listVIP.add("0966520960");    // A Vũ máy chủ
        listVIP.add("0328498462");    // A Sơn Android
        listVIP.add("0353465132");    // A Cường IOS
        listVIP.add("0865078933");    // A Đạt phần thẻ
        listVIP.add("0983895425");    // A Thịnh phần cứng
        listVIP.add("0982426814");    // Chị Trang chánh văn buồng

        listVIP.add("0986609344");    // A Tuấn HCM
        listVIP.add("0932524546");    // A Bằng Huế
        listVIP.add("0971937026");    // A Bích Hải Phòng
        listVIP.add("0907978098");    // Chị Thạo Cần Thơ
        listVIP.add("0918568518");    // A Khánh Đà Nẵng
        listVIP.add("0942707888");    // A Hùng Ngệ An
        listVIP.add("0963629355");    // Chị Nhi Đồng Nai
        listVIP.add("0946469704");    // A Thịnh Thanh Hóa
...
//        return text + "/" + Utility.getMD5(capt_confirm);
    ...
    public static String convertTime(String time)
    {
        ...
        try {
            ...
            SimpleDateFormat df2 = new SimpleDateFormat("dd/MM/yyyy   H:mm");
            dateText = df2.format(date);
        }catch (Exception e)
        {
            Logger.info("error: " + e.getMessage());
