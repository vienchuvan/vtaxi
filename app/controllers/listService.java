...
public class listService {
    ...
    public static String CONTENT_TYPE_CAMERA = "application/x-www-form-urlencoded";
    ...
    public static String SERVICE_TAOANH_info = "https://vimass.vn/vmbank/services/quanTriPush/taoAnh";
